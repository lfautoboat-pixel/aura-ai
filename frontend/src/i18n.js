...
const en = {
  ...
  invalid_code_error: "That code isn't right. Double-check the email and try again.",
...
const pt = {
  ...
  invalid_code_error: "Esse código não está certo. Confira o e-mail e tente de novo.",
...
const es = {
  ...
  invalid_code_error: "Ese código no es correcto. Revisa el correo e intenta de nuevo.",
